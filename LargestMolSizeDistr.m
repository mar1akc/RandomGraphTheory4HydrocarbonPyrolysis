...
largest_mol_hist_data_10RM_RGT = cell(3,Ndata);
for data_index = 1 : Ndata
    ...
    largest_mol_hist_data_10RM_RGT{1,data_index} = strcat(data_info(1,data_index),",",num2str(temperature(data_index)),"K,",num2str(n));
    largest_mol_hist_data_10RM_RGT{2,data_index} = Mcounts;
    largest_mol_hist_data_10RM_RGT{3,data_index} = Mvector;
    fprintf('data_index = %d\n',data_index);
end
save('Data/largest_mol_hist_data_10RM_RGT.mat',...
    'largest_mol_hist_data_10RM_RGT','HCratio','temperature');
end